...
import Pushpender from '../../../assets/images/Owner/Pushpender.jpg'
            ...
            <div className="row clearfix">
                ...
                <div className="col-lg-6 col-md-12 col-sm-12 content-column">
                    <div className="content-box mr_25">
                        <h2 style={{ color: "var(--theme-color)" }}>Pushpender Yadav</h2>
                        ...
                        <ul className="info-list mb_30 clearfix">
                            ...
                            <li>
                                <span>Email:</span> <Link href="mailto:Yadavpushpender22@gmail.com">Yadavpushpender22@gmail.com</Link>
                            </li>
                            <li>
                                <span>Phone:</span> <Link href="tel:919929800823">+91 9929800823
                                </Link>
                            </li>
                        </ul>
